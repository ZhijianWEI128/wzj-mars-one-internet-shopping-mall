			...
			<div class="w960 center">
				<ul>
					...
					<c:forEach items="${firstArticleTypes}" var="firstArticleType" >
						<li><a title="${firstArticleType.name}" href="${ctx}/doIndex?typecode=${firstArticleType.code}">${firstArticleType.name}</a></li>
					</c:forEach>
				</ul>
			</div>
		</div>
			...
			<div class="right-extra">
				...
				<ul id="book-price">
					...
					<li><font color="red">疯&nbsp;&nbsp;狂&nbsp;&nbsp;价：</font><span id="priceinfo"
						class="price">￥<fmt:formatNumber  pattern="0.00"  value="${article.price*article.discount}"/>  </span><span class="rate" id="pricediscount">（${article.discount}折）</span></li>
					<li class="sub">
				...
				<!-- 加入购物车表单 -->
				<form action="buyAction" method="post" id="buyform">
					<!-- 隐藏表单传递要购买的商品id -->
